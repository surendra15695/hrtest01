...
@Component({
  selector: 'app-processinvoicefor-ro',
  templateUrl: './processinvoicefor-ro.component.html',
  styleUrls: ['./processinvoicefor-ro.component.css']
})
export class ProcessinvoiceforROComponent implements OnInit {
  ...
  getAllProcessInvoiceListPending(){
    ...
    this.vendorService.getAllProcessInvoiceListForRO(this.searchFormProcessInvoiceList.value).subscribe((result) => {
      if (result) {
