...
@Component({
  selector: 'app-candidate-evaluateassessmentlist-component',
  templateUrl: './candidate-evaluateassessmentlist-component.component.html',
  styleUrls: ['./candidate-evaluateassessmentlist-component.component.css']
})
export class CandidateEvaluateassessmentlistComponentComponent implements OnInit {
  ...
  getBatchwiseEvaluateAssessmentList() {
    ...
    this.programcoordinatorService.getEvaluateAssessmentListBatchwise(this.searchEvaluateAssessment).subscribe((result) => {
      if (result) {
        ...
        console.log("evaluateAssessmentDetails", this.evaluateAssessmentDetails);
