...
@Component({
  selector: 'app-htsalescandidatelist',
  templateUrl: './htsalescandidatelist.component.html',
  styleUrls: ['./htsalescandidatelist.component.css']
})
export class HtsalescandidatelistComponent implements OnInit {
  ...
  onClickJoiningCheckList(data) {
    ...
    this._route.navigate(['/app/ht-joiningchecklist'], { queryParams: { CandidateId: data.candidateId, CandidateNo: data.candidateNo, From: "ht", Type: "S",HiringStatus: data.hiringStatusName  } });
  }
  // onclickrm()
  // {
  //   this._route.navigateByUrl('rm-joining-check-list');
  // }
  ...
  onClickVerifyDocument(data) {
    ...
    this.persistance.set('sendType', "S");
