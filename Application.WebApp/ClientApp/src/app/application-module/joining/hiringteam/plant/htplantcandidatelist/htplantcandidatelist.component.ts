...
@Component({
  selector: 'app-htplantcandidatelist',
  templateUrl: './htplantcandidatelist.component.html',
  styleUrls: ['./htplantcandidatelist.component.css']
})
export class HtplantcandidatelistComponent implements OnInit {
  ...
  onClickJoiningCheckList(data) {
    ...
    this._route.navigate(['/app/ht-joiningchecklist'], { queryParams: { CandidateId: data.candidateId, CandidateNo: data.candidateNo, From: "ht", Type: "P",HiringStatus: data.hiringStatusName } });
  }
  ...
  onClickVerifyDocument(data) {
    ...
    this.persistance.set('hiringname', data.hiringStatusName);
    this.persistance.set('sendType', "P");
