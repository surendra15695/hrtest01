...
@Component({
  selector: 'app-off-campus-interview-reimbursement-list-component',
  templateUrl: './off-campus-interview-reimbursement-list-component.component.html',
  styleUrls: ['./off-campus-interview-reimbursement-list-component.component.css']
})
export class OffCampusInterviewReimbursementListComponentComponent implements OnInit {
