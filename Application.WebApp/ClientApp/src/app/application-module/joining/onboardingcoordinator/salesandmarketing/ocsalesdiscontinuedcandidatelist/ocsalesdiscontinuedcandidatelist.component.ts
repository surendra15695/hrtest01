...
@Component({
  selector: 'app-ocsalesdiscontinuedcandidatelist',
  templateUrl: './ocsalesdiscontinuedcandidatelist.component.html',
  styleUrls: ['./ocsalesdiscontinuedcandidatelist.component.css']
})
export class OcsalesdiscontinuedcandidatelistComponent implements OnInit {
  ...
  onClickReassignCandidate(data) {
    ...
    if(data.batchId!=0 && data.batchId!=null){
      this._route.navigate(['/app/oc-reassign-candiadte'], { queryParams: { CandidateId: data.candidateId, BatchId: data.batchId, BatchNo: data.batchNo, For: "Candidate", Type: 'S', From: 'DCL',  ReqDetailsId: data.requisitionDetailId, EmpNo: data.empployeeNo } });
    }else{
      this._route.navigate(['/app/oc-reassign-individualcandiadte'], { queryParams: { CandidateId: data.candidateId, BatchId: data.batchId, BatchNo: data.batchNo, For: "Candidate", Type: 'S', From: 'DCL',  ReqDetailsId: data.requisitionDetailId, EmpNo: data.empployeeNo } });
