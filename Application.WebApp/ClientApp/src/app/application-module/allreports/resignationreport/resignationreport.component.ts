...
@Component({
  selector: 'app-resignationreport',
  templateUrl: './resignationreport.component.html',
  styleUrls: ['./resignationreport.component.css']
})
export class ResignationreportComponent implements OnInit {
  pageTitle: string = "Resignation Report";
