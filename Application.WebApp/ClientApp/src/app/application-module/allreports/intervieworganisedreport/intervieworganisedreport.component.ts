...
@Component({
  selector: 'app-intervieworganisedreport',
  templateUrl: './intervieworganisedreport.component.html',
  styleUrls: ['./intervieworganisedreport.component.css']
})
export class IntervieworganisedreportComponent implements OnInit {
  pageTitle: string = "Interview Organised Report";
  ...
  //   this.reportService.intervieworganisedreport(this.searchform.value).subscribe((result) => {
  //     if (result) {
