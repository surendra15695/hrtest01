...
@Component({
  selector: 'app-successionplanreport',
  templateUrl: './successionplanreport.component.html',
  styleUrls: ['./successionplanreport.component.css']
})
export class SuccessionplanreportComponent implements OnInit {
  pageTitle: string = "Succession Plan Report";
  ...
  //       if (this.loginRoleIds[i]=="15") {
  //         this.searchform.patchValue({approverAutoUserId:this.loginUserId}) ;  
  //       }
  ...
  //         this.searchform.patchValue({approverAutoUserId:0}) ;  
  //       }
  //     }
  //   console.log(this.searchform.value);
  //   this.SpinnerService.show();
  //   this.reportService.successionplanreport(this.searchform.value).subscribe((result) => {
  //     if (result) {
