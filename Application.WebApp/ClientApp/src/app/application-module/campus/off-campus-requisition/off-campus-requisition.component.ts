...
@Component({
  selector: 'app-off-campus-requisition',
  templateUrl: './off-campus-requisition.component.html',
  styleUrls: ['./off-campus-requisition.component.css']
})
export class OffCampusRequisitionComponent implements OnInit {
