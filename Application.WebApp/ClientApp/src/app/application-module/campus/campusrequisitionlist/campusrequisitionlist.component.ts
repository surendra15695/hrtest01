...
@Component({
  selector: 'app-campusrequisitionlist',
  templateUrl: './campusrequisitionlist.component.html',
  styleUrls: ['./campusrequisitionlist.component.css']
})
export class CampusrequisitionlistComponent implements OnInit {
