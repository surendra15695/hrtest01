...
import { ICampusYear,ISearchCampusYear ,ICampusCollegeCategory,ICampusCourseStream,ISearchCampusCourse,
  ICampusCourse } from '../../../interfaces/campus/campuscommon.interface';
...
export class SalesandmarketingComponent implements OnInit {
  ...
  formSubmit(){
   ...
   // console.log("submit data:",this.requisitionFormData);
  }
