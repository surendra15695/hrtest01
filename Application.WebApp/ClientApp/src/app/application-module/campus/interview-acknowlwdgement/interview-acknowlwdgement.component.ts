...
@Component({
  ...
  templateUrl: './interview-acknowlwdgement.component.html',
  styleUrls: ['./interview-acknowlwdgement.component.css']
})
export class InterviewAcknowlwdgementComponent implements OnInit {
  candidateId:any;
