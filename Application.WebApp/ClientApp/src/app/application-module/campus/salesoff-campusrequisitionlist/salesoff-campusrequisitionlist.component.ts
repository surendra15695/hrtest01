...
@Component({
  selector: 'app-salesoff-campusrequisitionlist',
  templateUrl: './salesoff-campusrequisitionlist.component.html',
  styleUrls: ['./salesoff-campusrequisitionlist.component.css']
})
export class SalesoffCampusrequisitionlistComponent implements OnInit {
