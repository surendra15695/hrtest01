...
@Component({
  selector: 'app-csmpus-candidate-salary-fitment',
  templateUrl: './csmpus-candidate-salary-fitment.component.html',
  styleUrls: ['./csmpus-candidate-salary-fitment.component.css']
})
export class CsmpusCandidateSalaryFitmentComponent implements OnInit {
  ...
  loadDatePickerFrom() {
    ...
    jQuery(".datepickerfrom").parent(".input-group").datepicker({
      ...
      // console.log("From ExpID", expFromId);
  ...
  getCandidateOfferDocument() {
    ...
    this.documentService.getCampusCandidateOfferDocumentForAdditional(this.searchDocument).subscribe((result) => {
      if (result) {
        //console.log(result);
  ...
  getCandidateList() {
    ...
    this.searchCandidate.RequisitionDetailId = null;
    this.candidateService.CandidateDetailsSalaryFitment(this.searchCandidate).subscribe((result) => {
      if (result) {
        this.candidates = result;
        if (this.candidates.length > 0) {
          this.candidateNo = this.candidates[0].candidateNo;
        }
        //  console.log("Candidates list", result);
      }
      else {
        this.candidates = [];
      }
  ...
  gotoCandidateList() {
    if(this.persistance.get('pagename')=="offsalary")
    {
    ...
    else if(this.persistance.get('pagename')=="rmcandidatelist"){
  ...
  onChangeTemplate(evt) {
    ...
    this.payStructureService.getAllSalaryTemplate(this.searchSalaryTemplate).subscribe((response: any) => {
      if (response) {
        ...
        //console.log(this.searchSalaryTemplateDetails);
      }
      else {
        this.salaryTemplateList = null;
      }
  ...
  getCalculatedSalaryTemplate() {
    ...
    //console.log(this.searchCalculatePayStructure);
    this.payStructureService.getCalculatedSalaryTemplate(this.searchCalculatePayStructure).subscribe((response: any) => {
      if (response) {
        ...
        //  console.log(this.calculatedSalary);
  ...
  submitData() {
    ...
    if (this.salaryFitmentRemarks.length > 0) {
      if (this.additionalRemarks == undefined || this.additionalRemarks == "") {
        ...
        for (var i = this.salaryFitmentRemarks.length; i > 0; i--) {
          ...
          j++;
          if (j > 0) {
            // console.log(this.salaryFitmentRemarks[i - 1]);
    ...
    if (flag == 0) {
      ...
      // console.log("-------------");
      // console.log(this.calculatedSalary.claCulatePayStructureValue);
      // console.log("-------------");
      ...
      //console.log(this.candidateSalaryFitmentSalaryDetailsFormat);
      ...
      //console.log(JSON.stringify(this.salaryFitmentExperience));
      ...
      this.salaryFitmentService.CampussaveSalaryFitment(formData).subscribe((result) => {
        //console.log(result);
  ...
  getSalaryFiltmentList() {
    ...
    this.searchSalaryFitment.requsitaionDetailsId = null;
    this.salaryFitmentService.getCampusSalaryFitment(this.searchSalaryFitment).subscribe((response: any) => {
      if (response) {
        ...
        //console.log("All Salary Data:", this.savedSalaryData);
        ...
        // console.log("New sal", this.savedSalaryData);
        // console.log("New new", this.salaryFitmentDataForPDF.new);
        ...
        //  console.log("check salaryFitment-", this.savedSalaryData.salaryFitmentDetails[0].gradeName);                     //arghya Date-27/06/2022
        ...
        //console.log("sal basic", this.salaryFitmentDataForPDF);
        ...
        //console.log("sal in", this.salaryFitmentDataForPDF);
  ...
  calculateBasicCTCPercent(data: any) {
    ...
    this.ourOffer = (this.finalCTC - this.oldCTC);
    ...
    // console.log(this.percentCTC);
    // console.log(this.percentBasic);
  }
