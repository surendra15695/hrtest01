...
@Component({
  selector: 'app-campus-corporate-review',
  templateUrl: './campus-corporate-review.component.html',
  styleUrls: ['./campus-corporate-review.component.css']
})
export class CampusCorporateReviewComponent implements OnInit {
