...
@Component({
  selector: 'app-campus-requisition-lsit-view-candidates',
  templateUrl: './campus-requisition-lsit-view-candidates.component.html',
  styleUrls: ['./campus-requisition-lsit-view-candidates.component.css']
})
export class CampusRequisitionLsitViewCandidatesComponent implements OnInit {
  ...
  gotoRequisitionDeatils() {
    ...
    if (this.persistance.get('pagename') == "salesandmarketing") {
      this.persistance.set('pagename', null);
      this._route.navigate(['app/campus/sales-requisition-list']);
    }
    else {
      this.persistance.set('pagename', null);
      this._route.navigate(['app/campus/requisition-list']);
    }
  }
  ...
  gotoSendOfferLetter(values) {
    jQuery(".custom-menu").hide();
    this.persistance.set('pagename', "campuscandidatelist");
  ...
  gotoViewDocuments(candidateId, requisitionDetailId) {
    jQuery(".custom-menu").hide();
    this.persistance.set('pagename', "Campuscandidatemanagement");
  ...
  gotoCandidateDetail(data) {
    jQuery(".custom-menu").hide();
    setTimeout(() => {
      this.persistance.set('pagename', "campusrequisitionlistcandidatedetails");
      //this.persistance.set('prevpagename', "campustalentpool");
      this.persistance.set('requisitionDetailId', this.requisitionDeatilId);
      this.persistance.set('candidateId', data.candidateId);
      this.persistance.set('hiringstatus', data.statusname);
