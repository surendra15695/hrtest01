...
@Component({
  selector: 'app-off-campus-submitted-result',
  templateUrl: './off-campus-submitted-result.component.html',
  styleUrls: ['./off-campus-submitted-result.component.css']
})
export class OffCampusSubmittedResultComponent implements OnInit {
