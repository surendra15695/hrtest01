...
@Component({
  selector: 'app-sales-marketing-campus-req-list',
  templateUrl: './sales-marketing-campus-req-list.component.html',
  styleUrls: ['./sales-marketing-campus-req-list.component.css']
})
export class SalesMarketingCampusReqListComponent implements OnInit {
  ...
  getAllCampusRequisitionList() {
    ...
    this.requisitionService.getAllCampusrequisition(this.searchform.value).subscribe((response: any) => {
      if (response) {
        this.requisitionList = response.filter( e => e.verticalId==2);
  ...
  gotoViewCandiate(value){
    ...
    this.persistance.set("pagename",'salesandmarketing');
