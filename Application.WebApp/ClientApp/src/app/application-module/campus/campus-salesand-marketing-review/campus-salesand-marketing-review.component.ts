...
@Component({
  selector: 'app-campus-salesand-marketing-review',
  templateUrl: './campus-salesand-marketing-review.component.html',
  styleUrls: ['./campus-salesand-marketing-review.component.css']
})
export class CampusSalesandMarketingReviewComponent implements OnInit {
  ...
  getAllocationPendingList() {
    ...
    this.chandHoldingService.getAllHandHoldingAllocationList(this.searchformAllocated.value).subscribe((result) => {
      if (result) {
        this.allocationPendingList = result.filter( e => e.probation !="6 Months" && e.reviewId==0);
        this.SpinnerService.hide();
      }
      else {
  ...
  getAllocationAllocatedList() {
    ...
    this.chandHoldingService.getAllHandHoldingAllocationList(this.searchformAllocated.value).subscribe((result) => {
      if (result) {
        this.allocationAllocatedList = result.filter(e => e.probation !="6 Months" && e.reviewId > 0);
        this.SpinnerService.hide();
      }
      else {
  ...
  gotoHRReview(data) {
    ...
    this.persistance.set('pagename', "campushrreview");
