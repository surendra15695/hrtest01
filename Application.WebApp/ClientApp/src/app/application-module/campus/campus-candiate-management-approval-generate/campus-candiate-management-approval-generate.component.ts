...
@Component({
  selector: 'app-campus-candiate-management-approval-generate',
  templateUrl: './campus-candiate-management-approval-generate.component.html',
  styleUrls: ['./campus-candiate-management-approval-generate.component.css']
})
export class CampusCandiateManagementApprovalGenerateComponent implements OnInit {
  ...
  submitData() {
   ...
   // formData.append("StatusFlag", this.onboardingMailIds[0].StatusFlag.toString());
    ...
    formData.append("CandidateName", this.candidateIdNames[0].candidateName);
      console.log(fromSignature);
      console.log(toSignature);
      console.log(JSON.stringify(this.managementApprovalData.managementApprovalCandidates))
      console.log(JSON.stringify(this.managementApprovalData.managementApprovalVacancy))
      this.managementApprovalService.CampusCandidateaddManagementApproval(formData).subscribe((result) => {
        console.log(result);
