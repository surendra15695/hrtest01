...
@Component({
  selector: 'app-salesandmarketing-hr-hand-holding',
  templateUrl: './salesandmarketing-hr-hand-holding.component.html',
  styleUrls: ['./salesandmarketing-hr-hand-holding.component.css']
})
export class SalesandmarketingHrHandHoldingComponent implements OnInit {
  ...
  onFeedback(data)
  {
    ...
    this.persistance.set('pagename', "salesandmarketinghrhandholding");
