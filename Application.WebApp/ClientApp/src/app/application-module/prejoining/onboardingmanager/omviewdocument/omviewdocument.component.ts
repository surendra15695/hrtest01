...
@Component({
  selector: 'app-omviewdocument',
  templateUrl: './omviewdocument.component.html',
  styleUrls: ['./omviewdocument.component.css']
})
export class OmviewdocumentComponent implements OnInit {
  ...
  constructor(
    ...
    //  if ((this.persistance.get('pagename') == "newjoinerslist" || this.persistance.get('pagename') == "viewcandidatelist") && this.persistance.get('nextpagename') == "ocviewdocument") {
  ...
  //         if (element_edit == element_rolearr || element_rolearr == 49) {  //&& this.attachedSubmittedDocumentArrayList[i].approvalStatus != 3
  ...
  gotoCandidateList() {
    ...
    if (this.pageName == "newjoinerslist") {
      ...
      this.persistance.set('parentActiveTab', this.parentActiveTab);
      this.persistance.set('childActiveTab', this.childActiveTab);
      this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: this.batchId, BatchNo: this.batchNo, OnBoardingcoordinator: this.onBoardingCoordinator } });
    }
  }
