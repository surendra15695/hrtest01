...
@Component({
  selector: 'app-omsalesandmarketingjoinerslist',
  templateUrl: './omsalesandmarketingjoinerslist.component.html',
  styleUrls: ['./omsalesandmarketingjoinerslist.component.css']
})
export class OmsalesandmarketingjoinerslistComponent implements OnInit {
  ...
  getPendingScheduleListBatchwise() {
    ...
    this.joinersservice.getAllPendingScheduleCandidateListBatchWise(this.searchformPendingScheduleBatch.value).subscribe((result) => {
      if (result) {
        // this.pendingScheduleCandidateListBatchWise = result.filter(x => x.verticalId == 3);
  ...
  getAllScheduledListBatchWise() {
    ...
    this.joinersservice.getAllScheduledBatchWise(this.searchformScheduledBatchWise.value).subscribe((result) => {
      if (result) {
        // this.scheduledBatchWise = result.filter(x => x.verticalId == 3);
  ...
  onClickViewCandidate(data, pagetext, parentTabName, childTabName) {
    ...
    if (roleIdArray.includes("49")) {
      this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: data.batchId, BatchNo: data.batchNo, OnBoardingcoordinator: data.onBoardingcoordinator, From: "OH", Type: "S" } });
    }
    else {
      this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: data.batchId, BatchNo: data.batchNo, OnBoardingcoordinator: data.onBoardingcoordinator, From: "OM", Type: "S" } });
    }
  }
  ...
  getAllBatch(verticalId) {
    ...
    this.commonService.getAllBatch(this.searchBatch).subscribe((result) => {
      if (result) {
        //  this.batchs = result.filter(x => x.createdBy == this.loginUserId);  // Previously
  ...
  onClickIndividualScheduleInduction(data) {
    ...
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", Mode: "Add", UserType: "OM" } });
  ...
  onClickBatchWiseInductionSchedule(data) {
    ...
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Sales", Mode: "Add", UserType: "OM" } });
  }
  onClicViewScheduleBatchWise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OM" } });
  ...
  onClickBookAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleaccommodation'], { queryParams: { AccommodationFor: "Candidate", AccommodationForId: data.candidateId, AccommodationForNo: data.candidateNo, From: "Sales", UserType: "OM" } });
  }
  onClickBookAccommodationBatchwise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    //this._route.navigate(['/scheduleaccommodation'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Sales", UserType: "OM" } });
    this._route.navigate(['/app/scheduleaccommodationbatch'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Sales", UserType: "OM" } });
  }
  // Edit Accommodation
  ...
  onClickEditAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/editaccommodation'], { queryParams: { EditAccommodationFor: "Candidate", EditAccommodationForId: data.candidateId, EditAccommodationForNo: data.candidateNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OM" } });
  }
  onClickEditAccommodationBatchWise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    // this._route.navigate(['/editaccommodation'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OM" } });
    this._route.navigate(['/app/editaccommodation-batch'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OM" } });
    ...
    if (flag == 0) {
      ...
      if (this.sharingType == "A") {
        ...
        this.saveShareWithCandidate.shareWithCandidates.forEach(can_element => {
          ...
          templatedescription = templatedescription.replace("@@ReportingLocation", venuDetail.reprtingVenueAddress + " at " + venuDetail.venueLocation);
          coordinatorDetails.forEach(training_element => {
            this.trainingCoordinatorDetails += training_element.trainingCoOrdinatorName + " in " + training_element.inductionVenueName + ","
          })
          templatedescription = templatedescription.replace("@@Coordinator", this.trainingCoordinatorDetails);
          can_element.templateBody = templatedescription;
          can_element.candidateJoiningDocumentId = this.joiningDocumentsIds;
  ...
  onClickIndividualViewSchedule(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OM" } });
  }
  onClickIndividualEditSchedule(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "Edit", UserType: "OM" } });
  }
  ...
  onClickJoiningCheckList(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/ocjoiningchecklist'], { queryParams: { CandidateId: data.candidateId, CandidateNo: data.candidateNo, From: "OM", Type: "S" } });
  }
  // for 5th module
