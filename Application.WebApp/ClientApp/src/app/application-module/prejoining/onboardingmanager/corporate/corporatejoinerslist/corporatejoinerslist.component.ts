...
@Component({
  selector: 'app-corporatejoinerslist',
  templateUrl: './corporatejoinerslist.component.html',
  styleUrls: ['./corporatejoinerslist.component.css']
})
export class CorporatejoinerslistComponent implements OnInit {
  ...
  createPendingScheduleBatchSearchForm() {
    this.searchformPendingScheduleBatch = this.fb.group({
      ...
      onBordingMangerId: null,
      onBordingCoordinatorId: null,
      verticalId: [1],             // this parameter need to be add in API also
      dtofJoiningFrom: [''],
      dtofJoiningTo: ['']
    });
  }
  ...
  createScheduledBatchwiseSearchForm() {
    this.searchformScheduledBatchWise = this.fb.group({
      ...
      onBordingMangerId: null,
      onBordingCoordinatorId: null,
      verticalId: [1],           // Parameter need to be add in API
      dtofJoiningFrom: [''],
      dtofJoiningTo: ['']
    });
  }
  ...
  getPendingScheduleListBatchwise() {
    ...
    this.joinersservice.getAllPendingScheduleCandidateListBatchWise(this.searchformPendingScheduleBatch.value).subscribe((result) => {
      if (result) {
        // this.pendingScheduleCandidateListBatchWise = result.filter(x => x.verticalId == 1);
  ...
  getAllScheduledListBatchWise() {
    ...
    this.joinersservice.getAllScheduledBatchWise(this.searchformScheduledBatchWise.value).subscribe((result) => {
      if (result) {
        // this.scheduledBatchWise = result.filter(x => x.verticalId == 1);
  ...
  onClickViewCandidate(data, pagetext, parentTabName, childTabName) {
    ...
    if (roleIdArray.includes("49")) {
      this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: data.batchId, BatchNo: data.batchNo, OnBoardingcoordinator: data.onBoardingcoordinator, From: "OH", Type: "C" } });
    }
    else {
      this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: data.batchId, BatchNo: data.batchNo, OnBoardingcoordinator: data.onBoardingcoordinator, From: "OM", Type: "C" } });
    }
  }
  ...
  getAllBatch(verticalId) {
    ...
    this.commonService.getAllBatch(this.searchBatch).subscribe((result) => {
      if (result) {
        //this.batchs = result.filter(x => x.createdBy == this.loginUserId);  // Previously it was
  ...
  onClickIndividualScheduleInduction(data) {
    ...
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Corporate", Mode: "Add", UserType: "OM" } });
  ...
  onClickBatchWiseInductionSchedule(data) {
    ...
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Corporate", Mode: "Add", UserType: "OM" } });
  }
  onClicViewScheduleBatchWise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Corporate", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OM" } });
  ...
  onClickBookAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleaccommodation'], { queryParams: { AccommodationFor: "Candidate", AccommodationForId: data.candidateId, AccommodationForNo: data.candidateNo, From: "Corporate", UserType: "OM" } });
  ...
  onClickBookAccommodationBatchwise(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    //this._route.navigate(['/scheduleaccommodation'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Corporate", UserType: "OM" } });
    this._route.navigate(['/app/scheduleaccommodationbatch'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Corporate", UserType: "OM" } });
  }
  // Edit Accommodation
  ...
  onClickEditAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/editaccommodation'], { queryParams: { EditAccommodationFor: "Candidate", EditAccommodationForId: data.candidateId, EditAccommodationForNo: data.candidateNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Corporate", UserType: "OM" } });
  }
  onClickEditAccommodationBatchWise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    // this._route.navigate(['/editaccommodation'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Corporate", UserType: "OM" } });
    this._route.navigate(['//appeditaccommodation-batch'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Corporate", UserType: "OM" } });
  ...
  onClickJoiningCheckList(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/ocjoiningchecklist'], { queryParams: { CandidateId: data.candidateId, CandidateNo: data.candidateNo, From: "OM", Type: "C" } });
  }
  ...
  onClickIndividualViewSchedule(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Corporate", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OM" } });
  }
  onClickIndividualEditSchedule(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Corporate", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "Edit", UserType: "OM" } });
  }
  ...
  onClickReassignInductionProgramCoordinator(data, Type) {
    this.reassignProgramCoordinatorForm.controls['assignedCoordinatorName'].disable();
    if (Type == "Batch") {
