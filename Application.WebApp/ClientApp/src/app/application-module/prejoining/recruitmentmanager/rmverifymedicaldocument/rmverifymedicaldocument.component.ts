...
@Component({
  selector: 'app-rmverifymedicaldocument',
  templateUrl: './rmverifymedicaldocument.component.html',
  styleUrls: ['./rmverifymedicaldocument.component.css']
})
export class RmverifymedicaldocumentComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.persistance.get('pagename') != null || this.persistance.get('nextpagename') != null) {
      if (this.persistance.get('pagename') == "rmcandidatemanagement" && this.persistance.get('nextpagename') == "candidatedocuments") {
  ...
  getCandidateOfferDocument() {
    ...
    this.documentService.getCandidateOfferDocument(this.searchDocument).subscribe((result) => {
      if (result) {
        //console.log("RM Document List", result);
