...
@Component({
  selector: 'app-ocviewdocument',
  templateUrl: './ocviewdocument.component.html',
  styleUrls: ['./ocviewdocument.component.css']
})
export class OcviewdocumentComponent implements OnInit {
  ...
  emaillist: ICandidateOfferDocument[] = [];
  ...
  constructor(
    ...
    private attachmentDocumentService: AttachmentdocumentService,    private locationService: LocationService,
    ...
    this.pagValueCorporate = this.persistance.get("tabledisplayStartC")
    this.previousValuesCorporate = this.persistance.get('previouspagefiltersC')
    this.pagValuePlant = this.persistance.get("tabledisplayStartP")
    this.previousValuesPlant = this.persistance.get('previouspagefiltersP')
    this.pagValueSales = this.persistance.get("tabledisplayStartSales")
    this.previousValuesSales = this.persistance.get('previouspagefiltersSales')
  ...
  gotoCandidateList() {
    ...
    if (this.pageName == "newjoinerslist") {
    ...
    } else if (this.pageName == "viewcandidatelist") {
      this.persistance.set('parentActiveTab', this.parentActiveTab);
      this.persistance.set('childActiveTab', this.childActiveTab);
    ...
    // else if (this.type == "ocrequsitioncandidateaction") {
    //   this.persistance.set('parentActiveTab', this.parentActiveTab);
    //   this.persistance.set('childActiveTab', this.childActiveTab);
    //   this._route.navigate(['/corporate/new-joiner-list/candidateaction']);
    // }  
    else if (this.pageName == "employeemanagement") {
      if (this.type == "corporate") {
        this.persistance.set('previouspageparamsC', this.previousValuesCorporate);
        this.persistance.set('tabledisplayStartC', this.pagValueCorporate);
        this._route.navigate(['/app/corporate/employee-management']);
      } else if (this.type == "plant") {
        this.persistance.set('previouspageparamsP', this.previousValuesPlant);
        this.persistance.set('tabledisplayStartP', this.pagValuePlant);
        this._route.navigate(['/app/plant/employee-management']);
      } else if (this.type == "sales") {
        this.persistance.set('previouspageparamsSales', this.previousValuesSales);
        this.persistance.set('tabledisplayStartSales', this.pagValueSales);
        this._route.navigate(['/app/sales/employee-management']);
      }
    }
  }
  getCandidateRemark() {
    ...
    this.offerLetterService.getOfferLetter(searchOfferLetter).subscribe((response: any) => {
      if (response.acknowlagementRemarks.length != 0) {
        this.candidateRemarkAftersalacpt = response.acknowlagementRemarks;
  ...
  submitData() {
    ...
    // }
      ...
      //formData.append("ApprovalStatus", this.documentData[0].)
      formData.append("Password", "welcome@1234");
