...
import { IInductionTemplate } from '../../../../interfaces/common/inductionassessment.interface';
...
@Component({
  selector: 'app-scheduleinduction',
  templateUrl: './scheduleinduction.component.html',
  styleUrls: ['./scheduleinduction.component.css']
})
export class ScheduleinductionComponent implements OnInit {
  ...
  // Trainer list
  // trainers: ITrainer[] = [];
  // selectedTrainer: ITrainer;
  // searchTrainer: IsearchTrainer = {
  ...
  getAllVerticals() {
    ...
    if (this.from.toUpperCase() == "PLANT") {
      ...
      this.selectedPendingVertical = this.verticals.find(e => e.verticalId == 3);
    }
...
class EditSchedule {
  ...
  FromTime: any;
  ToTime: any;
  BatchCandidateIds: any; // Added for multiple schedule
