...
@Component({
  selector: 'app-viewcandidatelist',
  templateUrl: './viewcandidatelist.component.html',
  styleUrls: ['./viewcandidatelist.component.css']
})
export class ViewcandidatelistComponent implements OnInit {
  ...
  getAllVerticals() {
    ...
    this.verticals.push({ verticalId: 3, verticalName: "Sales & Marketing", isActive: true });
    // }
    // Not requiured as they want all the vertical should be shown changed on 27-08-2022
    // if (this.type == "C") {
    //   this.verticals.push({ verticalId: 1, verticalName: "Corporate", isActive: true });
  ...
  onClickBack() {
    ...
    else if (this.from == "OH") { //added by Amartya
      this.persistance.set('parentActiveTab', this.parentActiveTab);
      this.persistance.set('childActiveTab', this.childActiveTab);
      jQuery(".custom-menu").hide();
      if (this.type == "C") {
