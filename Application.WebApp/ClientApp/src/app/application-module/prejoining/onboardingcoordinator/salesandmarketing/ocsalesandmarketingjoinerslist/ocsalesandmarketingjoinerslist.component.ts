...
@Component({
  selector: 'app-ocsalesandmarketingjoinerslist',
  templateUrl: './ocsalesandmarketingjoinerslist.component.html',
  styleUrls: ['./ocsalesandmarketingjoinerslist.component.css']
})
export class OcsalesandmarketingjoinerslistComponent implements OnInit {
  ...
  searchDocumentName: ISearchAttachmentDocumentName = {
    ...
    attachmentDocumentParticularId: 10,
    isActive: true
  }
  allUserList: any[] = [];
  searchRoleUser: any = {
  ...
  getPendingScheduleListindividually() {
    ...
    this.joinersservice.getAllPendingScheduleCandidateListIndividual(this.searchformPendingScheduleIndividual.value).subscribe((result) => {
      if (result) {
        // this.pendingScheduleCandidateindividual = result.filter(x => x.verticalId == 3);
  ...
  getAllScheduledListIndividually() {
    ...
    this.joinersservice.getAllScheduledIndividually(this.searchformScheduledIndividual.value).subscribe((result) => {
      if (result) {
        // this.scheduledIndividually = result.filter(x => x.verticalId == 3);
        this.scheduledIndividually = result;
        this.scheduledIndividually = this.scheduledIndividually.filter(x => x.onBoardingCoordinator == this.loginUserId);
        this.scheduledIndividually.forEach(element => {
          if (element.onboardingCordinatorNotApproveDoc != " ") {
            element.popoverContent = "<div><span class='grey'>Pending/Need clarification Document: </span><span>" + element.onboardingCordinatorNotApproveDoc + "</span></div>";
          }
  ...
  onClickViewCandidate(data, pagetext, parentTabName, childTabName) {
    ...
    this._route.navigate(['/app/viewcandidatedetails'], { queryParams: { BatchId: data.batchId, BatchNo: data.batchNo, OnBoardingcoordinator: data.onBoardingcoordinator, From: "OC", Type: "S" } });
  }
  ...
  onClickIndividualScheduleInduction(data) {
    ...
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", Mode: "Add", UserType: "OC" } });
  }
  onClickIndividualEditSchedule(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "Edit", UserType: "OC" } });
  }
  onClickIndividualViewSchedule(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Candidate", IndictionTypeId: data.candidateId, IndictionTypeNo: data.candidateNo, InductionJoiningType: "I", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OC" } });
  }
  onClickBatchWiseInductionSchedule(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Pending Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Sales", Mode: "Add", UserType: "OC" } });
  }
  onClicEditScheduleBatchWise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "Edit", UserType: "OC" } });
  ...
  onClicViewScheduleBatchWise(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    this._route.navigate(['/app/scheduleinduction'], { queryParams: { InductionType: "Batch", IndictionTypeId: data.batchId, IndictionTypeNo: data.batchNo, InductionJoiningType: "B", From: "Sales", CandidateInductionScheduleId: data.candidateInductionScheduleId, Mode: "View", UserType: "OC" } });
  ...
  onClickBookAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/scheduleaccommodation'], { queryParams: { AccommodationFor: "Candidate", AccommodationForId: data.candidateId, AccommodationForNo: data.candidateNo, From: "Sales", UserType: "OC" } });
  }
  onClickBookAccommodationBatchwise(data) {
    jQuery(".custom-menu").hide();
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    //this._route.navigate(['/scheduleaccommodation'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Sales", UserType: "OC" } });
    this._route.navigate(['/app/scheduleaccommodationbatch'], { queryParams: { AccommodationFor: "Batch", AccommodationForId: data.batchId, AccommodationForNo: data.batchNo, From: "Sales", UserType: "OC" } });
  }
  // Edit Accommodation
  ...
  onClickEditAccommodationIndividual(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    //this._route.navigate(['/editaccommodation'], { queryParams: { EditAccommodationFor: "Candidate", EditAccommodationForId: data.candidateId, EditAccommodationForNo: data.candidateNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales" } });
    this._route.navigate(['/app/editaccommodation'], { queryParams: { EditAccommodationFor: "Candidate", EditAccommodationForId: data.candidateId, EditAccommodationForNo: data.candidateNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OC" } });
  ...
  onClickEditAccommodationBatchWise(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Batch");
    //this._route.navigate(['/editaccommodation'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OC" } });
    this._route.navigate(['/app/editaccommodation-batch'], { queryParams: { EditAccommodationFor: "Batch", EditAccommodationForId: data.batchId, EditAccommodationForNo: data.batchNo, InductionScheduleId: data.candidateInductionScheduleId, From: "Sales", UserType: "OC" } });
  ...
  onClickJoiningCheckList(data) {
    ...
    this.persistance.set('parentActiveTab', "Scheduled");
    this.persistance.set('childActiveTab', "Individual");
    this._route.navigate(['/app/ocjoiningchecklist'], { queryParams: { CandidateId: data.candidateId, CandidateNo: data.candidateNo, From: "OC", Type: "S", HiringStatus: data.hiringStatusName } });
  }
  ...
  onClickReassignCandidate(data, parentTabName, childTabName) {
    ...
    this.persistance.set('parentActiveTab', parentTabName);
    this.persistance.set('childActiveTab', childTabName);
    // this._route.navigate(['/oc-reassign-candiadte'], { queryParams: { CandidateId: data.candidateId, For: "Candidate", Type: "S", CandidateInductionScheduleId: data.candidateInductionScheduleId } });
    this._route.navigate(['/app/oc-reassign-individualcandiadte'], { queryParams: { CandidateId: data.candidateId, BatchId: 0, BatchNo: "", For: "Candidate", Type: "S", ReqDetailsId: data.requisitionDetailId, EmpNo: data.empNp, VerticalID: this.verticalIds } });
  }
