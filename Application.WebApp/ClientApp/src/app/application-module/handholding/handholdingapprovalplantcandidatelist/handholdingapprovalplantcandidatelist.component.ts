...
@Component({
  selector: 'app-handholdingapprovalplantcandidatelist',
  templateUrl: './handholdingapprovalplantcandidatelist.component.html',
  styleUrls: ['./handholdingapprovalplantcandidatelist.component.css']
})
export class HandholdingapprovalplantcandidatelistComponent implements OnInit {
  ...
  getAllocationPendingList() {
    ...
    this.chandHoldingService.getAllHandholdingApproverPendingList(this.searchformPending.value).subscribe((result) => {
      if (result) {
        this.allocationPendingList = result.filter(e => e.statusId == "Pending");
  ...
  getAllocationAllocatedList() {
    this.SpinnerService.show();
    this.chandHoldingService.getAllHandholdingApproverPendingList(this.searchformAllocated.value).subscribe((result) => {
      if (result) {
        this.allocationAllocatedList = result.filter(e => e.statusId == "Approved");
        //console.log("Allocated List",this.allocationAllocatedList)
  ...
  gotoHandholdingForms(data){
    ...
    this.persistance.set('pagename', "handholdingPlantApprovalList")
