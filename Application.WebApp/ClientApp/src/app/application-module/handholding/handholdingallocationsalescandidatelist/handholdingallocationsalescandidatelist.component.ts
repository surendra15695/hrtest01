...
@Component({
  selector: 'app-handholdingallocationsalescandidatelist',
  templateUrl: './handholdingallocationsalescandidatelist.component.html',
  styleUrls: ['./handholdingallocationsalescandidatelist.component.css']
})
export class HandholdingallocationsalescandidatelistComponent implements OnInit {
  ...
  gotoHRFeedback(data) {
    ...
    this.persistance.set('pagename', "salescandidate");
