...
@Component({
  selector: 'app-plantjobshadowreviewlist',
  templateUrl: './plantjobshadowreviewlist.component.html',
  styleUrls: ['./plantjobshadowreviewlist.component.css']
})
export class PlantjobshadowreviewlistComponent implements OnInit {
  ...
  getAllocationPendingList() {
    ...
    this.chandHoldingService.getApproverJobShadowList(this.searchformPending.value).subscribe((result) => {
      if (result) {
  ...
  getAllocationAllocatedList() {
    this.SpinnerService.show();
    this.chandHoldingService.getApproverJobShadowList(this.searchformAllocated.value).subscribe((result) => {
      if (result) {
  ...
  gotoReviewApproval(data) {
    ...
    this.persistance.set('jobShadowReviewId', data.jobShadowReviewId);
    this.persistance.set('verticald', this.verticalId);
    this.persistance.set('pagename', "jobshadowapproval");
    this._route.navigate(['/app/candidate/job-shadow-review-approval']);
  }
