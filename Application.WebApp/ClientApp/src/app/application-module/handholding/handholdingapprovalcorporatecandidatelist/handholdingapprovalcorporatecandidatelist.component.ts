...
@Component({
  selector: 'app-handholdingapprovalcorporatecandidatelist',
  templateUrl: './handholdingapprovalcorporatecandidatelist.component.html',
  styleUrls: ['./handholdingapprovalcorporatecandidatelist.component.css']
})
export class HandholdingapprovalcorporatecandidatelistComponent implements OnInit {
  ...
  gotoHandholdingForms(data){
    ...
    this.persistance.set('pagename', "handholdingCorporateApprovalList")
