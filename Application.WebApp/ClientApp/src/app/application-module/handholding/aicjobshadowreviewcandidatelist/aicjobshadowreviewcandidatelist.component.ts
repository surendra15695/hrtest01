...
@Component({
  selector: 'app-aicjobshadowreviewcandidatelist',
  templateUrl: './aicjobshadowreviewcandidatelist.component.html',
  styleUrls: ['./aicjobshadowreviewcandidatelist.component.css']
})
export class AicjobshadowreviewcandidatelistComponent implements OnInit {
  ...
  getAllocatedCandidateList() {
    this.SpinnerService.show();
    this.chandHoldingService.getAllAICAllocatedJobShadowList(this.searchformAllocated.value).subscribe((result) => {
      if (result) {
  ...
  gotoJobShadowReview(data)
  {
    ...
    this.persistance.set('pagename', "aicjobshadowreview");
    this._route.navigate(['app/candidate/job-shadow-review']);
  }
