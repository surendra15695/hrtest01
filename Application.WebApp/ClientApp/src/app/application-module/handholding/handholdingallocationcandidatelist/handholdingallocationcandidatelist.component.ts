...
@Component({
  selector: 'app-handholdingallocationcandidatelist',
  templateUrl: './handholdingallocationcandidatelist.component.html',
  styleUrls: ['./handholdingallocationcandidatelist.component.css']
})
export class HandholdingallocationcandidatelistComponent implements OnInit {
  ...
  getAllAIC() {
    ...
    if (this.verticalId == 1) {
      this.searchRoleUser.roleId = 36
    }
    if (this.verticalId == 2) {
      this.searchRoleUser.roleId = 35
    }
    if (this.verticalId == 3) {
      this.searchRoleUser.roleId = 37
    }
    this.SpinnerService.show();
...
console.log(this.saveform.value);
  ...
  gotoHRFeedback(data) {
    ...
    this.persistance.set('pagename', "corporatecandidate");
