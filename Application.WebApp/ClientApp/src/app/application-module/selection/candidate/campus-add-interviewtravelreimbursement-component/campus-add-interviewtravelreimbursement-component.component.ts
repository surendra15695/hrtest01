...
@Component({
  selector: 'app-campus-add-interviewtravelreimbursement-component',
  templateUrl: './campus-add-interviewtravelreimbursement-component.component.html',
  styleUrls: ['./campus-add-interviewtravelreimbursement-component.component.css']
})
export class CampusAddInterviewtravelreimbursementComponentComponent implements OnInit {
  ...
  formSubmit() {
    ...
    if (flag == 0) {
      ...
      this.travelReimbursementService.CampusaddTravelReimbursement(formData).subscribe((result) => {
  ...
  gotoTravelReimbursement(){
    ...
    if(this.pagename=="offtravellist"){
      this._route.navigate(['/app/career/offcampus-interview-travel-reimbursement']);
    }
    else{
      this._route.navigate(['/app/career/offcampus-interview-travel-reimbursement']);
    }
