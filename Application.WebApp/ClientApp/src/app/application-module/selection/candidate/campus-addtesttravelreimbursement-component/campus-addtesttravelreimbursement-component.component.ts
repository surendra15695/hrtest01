...
@Component({
  selector: 'app-campus-addtesttravelreimbursement-component',
  templateUrl: './campus-addtesttravelreimbursement-component.component.html',
  styleUrls: ['./campus-addtesttravelreimbursement-component.component.css']
})
export class CampusAddtesttravelreimbursementComponentComponent implements OnInit {
  ...
  formSubmit() {
    ...
    if (flag == 0) {
      ...
      this.travelReimbursementService.CampusaddTestTravelReimbursement(formData).subscribe((result) => {
  ...
  gotoTravelReimbursement() {
    ...
    if (this.pagename == "offcampustesttravellist") {
      this._route.navigate(['/app/career/offcampus-test-travel-reimbursement']);
    }
    else {
      this._route.navigate(['/app/career/campus-test-travel-reimbursement']);
    }
