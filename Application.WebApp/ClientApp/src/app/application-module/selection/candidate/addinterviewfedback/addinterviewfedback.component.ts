...
@Component({
  selector: 'app-addinterviewfedback',
  templateUrl: './addinterviewfedback.component.html',
  styleUrls: ['./addinterviewfedback.component.css']
})
export class AddinterviewfedbackComponent implements OnInit {
  ...
  gotoFeedback() {
    ...
    this._route.navigate(['/app/career/feedback']);
  }
