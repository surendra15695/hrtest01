...
@Component({
  selector: 'app-campus-interviewtravelreimbursement-component',
  templateUrl: './campus-interviewtravelreimbursement-component.component.html',
  styleUrls: ['./campus-interviewtravelreimbursement-component.component.css']
})
export class CampusInterviewtravelreimbursementComponentComponent implements OnInit {
