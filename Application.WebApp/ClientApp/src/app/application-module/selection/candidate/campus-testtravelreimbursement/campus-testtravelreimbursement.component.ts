...
@Component({
  selector: 'app-campus-testtravelreimbursement',
  templateUrl: './campus-testtravelreimbursement.component.html',
  styleUrls: ['./campus-testtravelreimbursement.component.css']
})
export class CampusTesttravelreimbursementComponent implements OnInit {
  ...
  gotoAddTravelReimbursement(testScheduleDetailId){
    ...
    this.persistance.set('pagename', "campustesttravellist");
