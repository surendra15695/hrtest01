...
@Component({
  selector: 'app-travelreimbursementlist',
  templateUrl: './travelreimbursementlist.component.html',
  styleUrls: ['./travelreimbursementlist.component.css']
})
export class TravelreimbursementlistComponent implements OnInit {
  ...
  getAllTravelReimbursementList(){
    ...
    this.travelReimbursementService.getCandidateTravelReimbursementList(this.searchTravelReimbursementList).subscribe((result) => {
      if (result) {
  ...
  gotoAddTravelReimbursement(interviewDetailId){
    ...
    this._route.navigate(['/app/career/add-travel-reimbursement']);
  }
