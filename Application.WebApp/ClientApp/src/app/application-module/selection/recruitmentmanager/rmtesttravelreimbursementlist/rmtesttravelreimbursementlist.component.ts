...
@Component({
  selector: 'app-rmtesttravelreimbursementlist',
  templateUrl: './rmtesttravelreimbursementlist.component.html',
  styleUrls: ['./rmtesttravelreimbursementlist.component.css']
})
export class RmtesttravelreimbursementlistComponent implements OnInit {
  ...
  fromPendingSubmit() {
    ...
    this.travelReimbursementService.getRMTestTravelReimbursementDetailList(this.searchpendingform.value).subscribe((result) => {
      if (result) {
  ...
  fromProcessedSubmit() {
    ...
    this.travelReimbursementService.getRMTestTravelReimbursementDetailList(this.searchprocessedform.value).subscribe((result) => {
      if (result) {
  ...
  gotoViewDetail(testScheduleDetailId, candidateNo, PageName) {
    jQuery(".custom-menu").hide();
    ...
    this._route.navigate(['/app/test-travel-reimbursement-list/view']); 
  }
  showProcessed() {
    this.fromProcessedSubmit();
    setTimeout(() => {
