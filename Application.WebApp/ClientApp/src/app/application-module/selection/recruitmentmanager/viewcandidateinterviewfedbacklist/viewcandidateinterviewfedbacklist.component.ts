...
import {
  ISearchCandidateInterviewFeedback, ICandidateInterviewFeedbackList,
...
@Component({
  selector: 'app-viewcandidateinterviewfedbacklist',
  templateUrl: './viewcandidateinterviewfedbacklist.component.html',
  styleUrls: ['./viewcandidateinterviewfedbacklist.component.css']
})
export class ViewcandidateinterviewfedbacklistComponent implements OnInit {
  ...
  suggestion: string = "";
  feedbackDetail:ICandidateInterviewFeedbackData;
  constructor(
    ...
    if(this.persistance.get('pagename') == "rmviewcandidatefeedback"){
      this.candidateId = this.persistance.get('paramid2');   
    ...
    if(this.persistance.get('pagename') == "cmviewassessment"){
      ...
      this.interviewDetailId = this.persistance.get('interviewDetailId');
    }
  ...
  getFeedback(){
    ...
    this.interviewService.getCandidateInterviewFeedbackDetail(formData).subscribe((result) => {
      if (result) {
  ...
  addFeedback() {
    ...
    if (this.applicationSystemRate == 0
      ...
      this.interviewService.addCandidateInterviewFeedback(formData).subscribe((result) => {
        if (result) {
  ...
  gotoFeedback(){
    ...
    if(this.persistance.get('pagename') == "offcampustalentpool"){
      ...
      this.persistance.set('paramid3', null);
