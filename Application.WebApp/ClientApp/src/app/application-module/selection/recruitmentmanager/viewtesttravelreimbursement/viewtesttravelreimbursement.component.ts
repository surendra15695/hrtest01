...
@Component({
  selector: 'app-viewtesttravelreimbursement',
  templateUrl: './viewtesttravelreimbursement.component.html',
  styleUrls: ['./viewtesttravelreimbursement.component.css']
})
export class ViewtesttravelreimbursementComponent implements OnInit {
  ...
  gotoTravelReimbursementList() {
    ...
    this._route.navigate(['/app/test-travel-reimbursement-list']);
  }
