...
@Component({
  selector: 'app-pdfmedicalreimbursement-forzip',
  templateUrl: './pdfmedicalreimbursement-forzip.component.html',
  styleUrls: ['./pdfmedicalreimbursement-forzip.component.css']
})
export class PdfmedicalreimbursementForzipComponent implements OnInit {
