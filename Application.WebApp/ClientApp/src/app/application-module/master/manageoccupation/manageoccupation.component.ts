...
@Component({
  selector: 'app-manageoccupation',
  templateUrl: './manageoccupation.component.html',
  styleUrls: ['./manageoccupation.component.css']
})
...
export class ManageoccupationComponent implements OnInit {
  ...
  onSubmit(){    
    ...
    this.commonService.addOccupation(this.saveForm.value).subscribe((response: any) => {      
  ...
  onEdit(RowData: any){
    ...
    this.saveForm.patchValue({
      ...
      OccupationId: RowData.occupationId,
  ...
  getAllOccupationList(){
    ...
    this.commonService.getAllOccupationList(this.saveForm.value).subscribe((response: any) => {            
      if(response){
