...
export class ManageRelationshipComponent implements OnInit {
  ...
  onSubmit(){    
    ...
    this.commonService.addRelationship(this.saveForm.value).subscribe((response: any) => {      
  ...
  getAllRelationship(){
    ...
    this.commonService.getAllRelationship(this.saveForm.value).subscribe((response: any) => {            
      if(response){
