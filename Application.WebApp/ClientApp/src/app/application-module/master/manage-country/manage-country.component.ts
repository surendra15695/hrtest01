...
export class ManageCountryComponent implements OnInit {
  ...
  onSubmit(){    
    ...
    this.commonService.addCountryList(this.saveForm.value).subscribe((response: any) => {      
  ...
  getAllCountryList(){
    ...
    this.commonService.getAllCountryList(this.saveForm.value).subscribe((response: any) => {            
      if(response){
