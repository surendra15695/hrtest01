...
@Component({
  selector: 'app-manage-interviewvenue',
  templateUrl: './manage-interviewvenue.component.html',
  styleUrls: ['./manage-interviewvenue.component.css']
})
export class ManageInterviewvenueComponent implements OnInit {
  ...
  createForm() {
    ...
    this.saveForm = this.fb.group({
      InterviewVenueId: [0],
      InterviewVenueName: ['', Validators.required],
      InterviewVenueAddress: ['', Validators.required],
      IsActive: [true],
  ...
  onSubmit() {
    this.spinnerService.show();
    this.commonService.addInterviewVenue(this.saveForm.value).subscribe((response: any) => {
  ...
  onEdit(Data: any) {
    ...
    this.saveForm.patchValue({
      InterviewVenueId: Data.venueId,
      InterviewVenueName: Data.venueName,
      InterviewVenueAddress: Data.venueAddress,
