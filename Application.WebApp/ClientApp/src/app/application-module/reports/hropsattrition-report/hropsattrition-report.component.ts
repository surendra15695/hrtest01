...
@Component({
  selector: 'app-hropsattrition-report',
  templateUrl: './hropsattrition-report.component.html',
  styleUrls: ['./hropsattrition-report.component.css']
})
export class HropsattritionReportComponent implements OnInit {
...
getdata()
{
  ...
  this.searchform.patchValue(
    ...
    this.reportService.hrOpsAttritionReport(this.searchform.value).subscribe((result) => {
      if (result) {
        this.hrOpsAttritionList = result;
        this.loadDataTable();
        this.SpinnerService.hide();
        console.log("list", this.hrOpsAttritionList)
      }
      else {
        this.hrOpsAttritionList = [];
        this.SpinnerService.hide();
  ...
  exportToExcel() {
    ...
    link.download = "HROps Attrition Report.xls";
