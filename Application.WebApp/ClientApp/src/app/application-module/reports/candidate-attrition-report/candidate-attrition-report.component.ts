...
@Component({
  selector: 'app-candidate-attrition-report',
  templateUrl: './candidate-attrition-report.component.html',
  styleUrls: ['./candidate-attrition-report.component.css']
})
export class CandidateAttritionReportComponent implements OnInit {
  ...
  formSubmit() {
    ...
    this.searchform.patchValue(
      ...
      if(flag==0){
        this.candidateAttritionList = [];
        this.SpinnerService.show();
        this.reportService.candidateAttritionReport(this.searchform.value).subscribe((result) => {
        if (result) {
          this.candidateAttritionList = result;
          console.log("DataList", this.candidateAttritionList)
          this.loadDataTable();
          this.SpinnerService.hide();
        }
          else {
  ...
  exportToExcel() {
    this.excelService.ExportAsExcelFile(this.candidateAttritionList, "Report_CandidateAttrition");
  }
