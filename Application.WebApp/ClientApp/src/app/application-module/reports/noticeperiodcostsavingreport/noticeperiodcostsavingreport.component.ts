...
@Component({
  selector: 'app-noticeperiodcostsavingreport',
  templateUrl: './noticeperiodcostsavingreport.component.html',
  styleUrls: ['./noticeperiodcostsavingreport.component.css']
})
export class NoticeperiodcostsavingreportComponent implements OnInit {
  ...
  gradeId: number;
  gradeName: string;
  noticePeriodCostSavingList: any[] = [];
  ...
  formSubmit() {
    ...
    this.searchform.patchValue(
      ...
      if(flag ==0){
      this.noticePeriodCostSavingList = [];
      this.SpinnerService.show();
      this.reportService.reportnoticeperiodcostsaving(this.searchform.value).subscribe((result) => {
      if (result) {
        this.noticePeriodCostSavingList = result;
        this.loadDataTable();
        this.SpinnerService.hide();
      }
      else {
  ...
  exportToExcel() {
    this.excelService.ExportAsExcelFile(this.noticePeriodCostSavingList, "Report_Noticeperiodcostsaving");
  }
  reset() {
