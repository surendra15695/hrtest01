...
@Component({
  selector: 'app-referred-candidate-report',
  templateUrl: './referred-candidate-report.component.html',
  styleUrls: ['./referred-candidate-report.component.css']
})

export class ReferredCandidateReportComponent implements OnInit {
  ...
  ExportReport(){
    if(this.candidates.length != 0){
      this.excelService.ExportAsExcelFile(this.candidates, 'ReferredCanReport_');
    }    
  }
