...
@Component({
  selector: 'app-cons-payment-tracker-report',
  templateUrl: './cons-payment-tracker-report.component.html',
  styleUrls: ['./cons-payment-tracker-report.component.css']
})
export class ConsPaymentTrackerReportComponent implements OnInit {
  ...
  formSubmit() {
    ...
    this.searchform.patchValue(
      ...
      if(flag==0){
        this.consPaymentTrackerList = [];
        this.SpinnerService.show();
        this.reportService.consPaymentTrackerReport(this.searchform.value).subscribe((result) => {
          if (result) {
            this.consPaymentTrackerList = result;
            this.loadDataTable();
            this.SpinnerService.hide();
          }
          else {
  ...
  exportToExcel() {
    this.excelService.ExportAsExcelFileForReport(this.consPaymentTrackerList, "Cons. Payment Tracker Report");
  }
