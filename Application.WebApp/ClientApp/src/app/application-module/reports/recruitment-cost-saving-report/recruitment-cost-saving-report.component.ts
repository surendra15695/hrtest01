...
@Component({
  selector: 'app-recruitment-cost-saving-report',
  templateUrl: './recruitment-cost-saving-report.component.html',
  styleUrls: ['./recruitment-cost-saving-report.component.css']
})
export class RecruitmentCostSavingReportComponent implements OnInit {
  ...
  formSubmit() {
   ...
   if(flag==0){
    this.recrumentCostSavingList = [];
    this.SpinnerService.show();
    this.reportService.recruitmentCostSavingReport(this.searchform.value).subscribe((result) => {
      if (result) {
        this.recrumentCostSavingList = result;
        this.loadDataTable();
        this.SpinnerService.hide();
        console.log("list", this.recrumentCostSavingList)
      }
      else {
        this.recrumentCostSavingList = [];
        this.SpinnerService.hide();
  ...
  exportToExcel() {
    ...
    link.download = "RecruitmentCostSavingReport.xls";
