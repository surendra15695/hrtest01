...
@Component({
  selector: 'app-createapplicationformb',
  templateUrl: './createapplicationformb.component.html',
  styleUrls: ['./createapplicationformb.component.css']
})
export class CreateapplicationformbComponent implements OnInit {
  ...
  candidateProfile: ICampusCandidateProfile;
  ...
  getAllRelativeRelations() {
    ...
    this.positionService.GetFamilyRelation(data).subscribe((result) =>{
      if(result){
  ...
  getCandidateProfile() {
    ...
    this.candidateService.getCampusCandidateProfileApplication(this.searchCandidateProfile).subscribe((result) => {
      if (result) {
        ...
        this.campusplacement = this.candidateProfile.campusplacement; //added on 02-12-2023 Based on Requirement
  ...
  changeJobPortal(evt) {
    ...
    this.campusplacement = false;
    this.candidateProfile.campusplacement = false;
  }
  ...
  changeCampusplacement(evt) {

    this.campusplacement = true;
    this.candidateProfile.campusplacement = true;
  ...
  submit() {
    ...
    if (this.signatreData == undefined) {
  ...
  SaveApplicationForm(submitStatus) {
    ...
    if (flag == 0) {
      ...
      formData.append("CampusPlacement", this.candidateProfile.campusplacement.toString()); //added based on requirement 
      ...
      this.SpinnerService.show();
      this.candidateService.saveCampusCandidateProfile(formData).subscribe((result) => {
