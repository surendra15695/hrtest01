...
import { ISearchSuccessionPlanList, ISuccessionPlanList } from '../../../../../interfaces/preselection/successionplan.interface';
...
@Component({
  selector: 'app-approversuccessionplanlist',
  templateUrl: './approversuccessionplanlist.component.html',
  styleUrls: ['./approversuccessionplanlist.component.css']
})
export class ApproversuccessionplanlistComponent implements OnInit {
  pageTitle = "Succession Plan - Pending Action";
  ...
  createForm() {
    this.searchform = this.fb.group({
      ...
      fromDate: [''],
      toDate: [''],
      successionPlanApprovalStatus: [0],
  ...
  //     });
  //   this.SpinnerService.show();
  //   this.successionService.getAllSuccessionPlanList(this.searchform.value).subscribe((result) => {
  //     if (result) {
  ...
  openApproveRejectModal(id, pos) {
    ...
    this.successionPlanDetailId = id;
  ...
  reject() {
    if (confirm("Are you sure to reject ")) {
      this.saveform.patchValue({
        SuccessionPlanDetailId: this.successionPlanDetailId,
        StatusId: 4,
        CreatedBy: this.createdBy
      })
      this.SpinnerService.show();
      this.successionService.successionPlanApproveReject(this.saveform.value).subscribe((result) => {
        if (result) {
          // console.log(result);
