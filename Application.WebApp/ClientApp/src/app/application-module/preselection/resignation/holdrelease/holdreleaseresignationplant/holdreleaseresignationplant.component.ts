...
@Component({
  selector: 'app-holdreleaseresignationplant',
  templateUrl: './holdreleaseresignationplant.component.html',
  styleUrls: ['./holdreleaseresignationplant.component.css']
})
export class HoldreleaseresignationplantComponent implements OnInit {
  ...
  getAllJobDescription() {
    ...
    this.jobDescriptionService.getAllJobDescription(this.searchJobDescription).subscribe((result) => {
      if (result) {
        ...
        //console.log("Job Description", this.jobdescriptions);
