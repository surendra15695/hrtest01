...
@Component({
  selector: 'app-holdreleaseresignationsales',
  templateUrl: './holdreleaseresignationsales.component.html',
  styleUrls: ['./holdreleaseresignationsales.component.css']
})
export class HoldreleaseresignationsalesComponent implements OnInit {
