...
@Component({
  selector: 'app-resignationplant',
  templateUrl: './resignationplant.component.html',
  styleUrls: ['./resignationplant.component.css']
})
export class ResignationplantComponent implements OnInit {
  ...
  locationId: number;
  //----Piu
  //searchHROpsEmail: ISearchHROpsEmail =
  //  {
  //    verticalId: null,
  //    createdBy: null
  //  }
  ...
  //HROpsEmailTemplate   -----Piu
  //getAllHROpsEmail() {
  //  this.searchHROpsEmail.verticalId = this.StaticVerticalId;
  //  this.locationService.getAllHROpsEmail(this.searchHROpsEmail).subscribe((result) => {
  //    if (result) {
  //      this.searchHROpsEmail = result;

  //      this.searchHROpsEmail = this.searchHROpsEmail;
  //    }
  //    else {
  //      this.searchHROpsEmail = null;
  //    }
  //  }, error => {
  //    console.log(error);
  //  }, () => {
