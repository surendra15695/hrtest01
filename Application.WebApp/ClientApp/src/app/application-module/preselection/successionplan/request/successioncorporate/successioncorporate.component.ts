...
@Component({
  selector: 'app-successioncorporate',
  templateUrl: './successioncorporate.component.html',
  styleUrls: ['./successioncorporate.component.css']
})
export class SuccessioncorporateComponent implements OnInit {
