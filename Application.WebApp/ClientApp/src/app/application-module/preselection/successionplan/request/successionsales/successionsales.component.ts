...
@Component({
  selector: 'app-successionsales',
  templateUrl: './successionsales.component.html',
  styleUrls: ['./successionsales.component.css']
})
export class SuccessionsalesComponent implements OnInit {
  pageTitle = "Succession Plan - New Request";
