...
@Component({
  selector: 'app-holdreleasesuccessionsales',
  templateUrl: './holdreleasesuccessionsales.component.html',
  styleUrls: ['./holdreleasesuccessionsales.component.css']
})
export class HoldreleasesuccessionsalesComponent implements OnInit {
