...
@Component({
  selector: 'app-holdreleasesuccessioncorporate',
  templateUrl: './holdreleasesuccessioncorporate.component.html',
  styleUrls: ['./holdreleasesuccessioncorporate.component.css']
})
export class HoldreleasesuccessioncorporateComponent implements OnInit {
