...
@Component({
  selector: 'app-holdreleasecorporate',
  templateUrl: './holdreleasecorporate.component.html',
  styleUrls: ['./holdreleasecorporate.component.css']
})
export class HoldreleasecorporateComponent implements OnInit {
