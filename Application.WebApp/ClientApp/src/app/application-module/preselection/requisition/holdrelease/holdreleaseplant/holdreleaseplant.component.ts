...
@Component({
  selector: 'app-holdreleaseplant',
  templateUrl: './holdreleaseplant.component.html',
  styleUrls: ['./holdreleaseplant.component.css']
})
export class HoldreleaseplantComponent implements OnInit {
