...
@Component({
  selector: 'app-requesterrequisitionlist',
  templateUrl: './requesterrequisitionlist.component.html',
  styleUrls: ['./requesterrequisitionlist.component.css']
})
export class RequesterrequisitionlistComponent implements OnInit {
  ...
  //       locationId: Number(this.searchform.value.locationId),
  //       requisitionApprovalStatus: Number(this.searchform.value.requisitionApprovalStatus)
  //     });
  //   //console.log("Search value",this.searchform.value);
  //   this.SpinnerService.show();
  //   this.requisitionService.getAllRequisition(this.searchform.value).subscribe((result) => {
  //     if (result) {
  //       //console.log("Requestor Requisition List", result);
  //       this.requisitionLists = result;
  //       //console.log("data", this.requisitionLists);
  //       this.loadDataTable();
  //     }
  //     else {
  ...
  reset() {
    ...
    this.searchform.patchValue({
      ...
      requisitionApprovalStatus: 0,
      verticalId: Number(this.selectedVertical.verticalId),
      createdBy: this.loginUserId,                              // By Arnab on 05-08-2023
  ...
  gotoCandidateList(id) {
    ...
    this.persistance.set('pagename', "requesterrequisitionlist");
    this.persistance.set('paramid', id);
    // this.persistance.set('hrStatus', hrStatus); // Added Anif
    this._route.navigate(['/app/requesterrequisitionlist/candidatelist']);
  }
