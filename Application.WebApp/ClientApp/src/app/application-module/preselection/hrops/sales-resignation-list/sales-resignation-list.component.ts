...
@Component({
  selector: 'app-sales-resignation-list',
  templateUrl: './sales-resignation-list.component.html',
  styleUrls: ['./sales-resignation-list.component.css']
})
export class SalesResignationListComponent implements OnInit {

  pageTitle: string = "Sales Resignation List";
  ...
  getAllVerticals() {
    ...
    this.selectedVertical = this.verticals.filter(x => x.verticalId == 3)[0];
    this.getAllFunction();
  }
