...
@Component({
  selector: 'app-corporate-resignation-list',
  templateUrl: './corporate-resignation-list.component.html',
  styleUrls: ['./corporate-resignation-list.component.css']
})
export class CorporateResignationListComponent implements OnInit {
