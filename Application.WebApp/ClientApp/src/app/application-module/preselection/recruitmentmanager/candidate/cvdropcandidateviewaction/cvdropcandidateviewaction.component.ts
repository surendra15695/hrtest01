...
import { ICandidateDetailData, ICandidateDetailDataForPosition, ISearchCandidateDetail, IcandidateremarksList } from '../../../../../interfaces/preselection/candidate.interface';
...
@Component({
  selector: 'app-cvdropcandidateviewaction',
  templateUrl: './cvdropcandidateviewaction.component.html',
  styleUrls: ['./cvdropcandidateviewaction.component.css']
})
export class CvdropcandidateviewactionComponent implements OnInit {
  ...
  candidates: ICandidateDetailDataForPosition[] = [];
