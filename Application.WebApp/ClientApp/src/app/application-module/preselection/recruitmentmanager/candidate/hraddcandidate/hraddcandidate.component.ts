...
@Component({
  selector: 'app-hraddcandidate',
  templateUrl: './hraddcandidate.component.html',
  styleUrls: ['./hraddcandidate.component.css']
})
export class HraddcandidateComponent implements OnInit {
  ...
  constructor(
    ...
    this.alldata=this.persistance.get('func');
  ...
  onSubmit() {
    ...
    if (flag == 0) {
      ...
      formData.append("SourceChannelId", "1");
      ...
      formData.append("position",this.alldata.positionName);
      formData.append("department",this.alldata.department);
      formData.append("location",this.alldata.locationOffice);
      formData.append("function",this.alldata.functionName);
      formData.append("reqno",this.alldata.requisitionNo);
