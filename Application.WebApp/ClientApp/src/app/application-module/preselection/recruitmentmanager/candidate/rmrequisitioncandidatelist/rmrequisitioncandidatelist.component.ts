...
@Component({
  selector: 'app-rmrequisitioncandidatelist',
  templateUrl: './rmrequisitioncandidatelist.component.html',
  styleUrls: ['./rmrequisitioncandidatelist.component.css']
})
export class RmrequisitioncandidatelistComponent implements OnInit {
  ...
  closeStream: boolean;
  closedomain: boolean;
  closesubdomain: boolean;
  closelocation: boolean;
  closesourcechannel
  ...
  btnViewManagementApprovalVisible: boolean = false;
  ...
  constructor(
    ...
    if (this.persistance.get('pagename') != null) {
      ...
      if (this.persistance.get('pagename') == "rmrequisitionlist" || this.persistance.get('pagename') == "requesterrequisitionlist" ||
        ...
        this.data = this.persistance.get('func');
        this.getAllGender();
        this.getAllDomain();
        this.getAllState();
        ...
        debugger
        if (this.persistance.get('previouspagefilter') != (null || undefined)) {
          debugger
          var params = this.persistance.get('previouspagefilter');
          this.reloadFilter(params);
          setTimeout(() => {
  ...
  changeCourse() {
    if (this.filterForm.value.CourseId[0] == 0) {
      if (this.courses.length == (this.courselength)) {
        ...
        for (let i = 0; i < this.courses.length; i++) {
          this.filterForm.value.CourseId.push((this.courses[i].courseId))
        }
  ...
  closecourse(selectElement: HTMLSelectElement) {
    if (this.closeCourse) {
      selectElement.click();
  ...
  changeStream() {
    if (this.filterForm.value.StreamId[0] == 0) {
      if (this.streams.length == (this.streamlength)) {
        ...
        for (let i = 0; i < this.streams.length; i++) {
          this.filterForm.value.StreamId.push((this.streams[i].streamId))
        }
  ...
  closestream(selectElement: HTMLSelectElement) {
    if (this.closeStream) {
      selectElement.click();
      this.elementRef.nativeElement.querySelector('.dropdown-menu').classList.remove('show');
    }
  ...
  changeSubDomain() {
    if (this.filterForm.value.SubDomainId[0] == 0) {
      if (this.subdomain.length == (this.subdomainlength)) {
  ...
  changeLocation() {
    if (this.filterForm.value.StateIds[0] == 0) {
      if (this.State.length == (this.locationlength)) {
        this.filterForm.value.StateIds = [];
        this.locationlength = this.filterForm.value.StateIds.length;
      }
      else {
        this.filterForm.value.StateIds = [];
  ...
  closeLocation(selectElement: HTMLSelectElement) {
  ...
  filtervalue() {
    this.filtervalues.CandidateName = this.filterForm.value.CandidateName;
    this.filtervalues.FromDate = this.filterForm.value.FromDate;
    this.filtervalues.ToDate = this.filterForm.value.ToDate;
    this.filtervalues.HiringStatusId = this.filterForm.value.HiringStatusId;
    this.filtervalues.GenderId = this.filterForm.value.GenderId;
    this.filtervalues.FromAge = this.filterForm.value.FromAge;
    this.filtervalues.ToAge = this.filterForm.value.ToAge;
    this.filtervalues.AadharNo = this.filterForm.value.AadharNo;
    this.filtervalues.ContactNo = this.filterForm.value.ContactNo;
    this.filtervalues.EmailId = this.filterForm.value.EmailId;
    this.filtervalues.MotherTongueIds = this.filterForm.value.MotherTongueIds;
    this.filtervalues.LanguageIds = this.filterForm.value.LanguageIds;
    this.filtervalues.QualificationId = this.filterForm.value.QualificationId;
    this.filtervalues.CourseId = this.filterForm.value.CourseId;
    this.filtervalues.StreamId = this.filterForm.value.StreamId;
    this.filtervalues.FromPercent = this.filterForm.value.FromPercent;
    this.filtervalues.ToPercent = this.filterForm.value.ToPercent;
    this.filtervalues.CompletionYear = this.filterForm.value.CompletionYear;
    this.filtervalues.QualificationTypeId = this.filterForm.value.QualificationTypeId;
    this.filtervalues.FromExperience = this.filterForm.value.FromExperience;
    this.filtervalues.ToExperience = this.filterForm.value.ToExperience;
    this.filtervalues.FromCTC = this.filterForm.value.FromCTC;
    this.filtervalues.ToCTC = this.filterForm.value.ToCTC;
    this.filtervalues.CurrentEmployer = this.filterForm.value.CurrentEmployer;
    this.filtervalues.Designation = this.filterForm.value.Designation;
    this.filtervalues.DomainId = this.filterForm.value.DomainId;
    this.filtervalues.SubDomainId = this.filterForm.value.SubDomainId;
    this.filtervalues.StateIds = this.filterForm.value.StateIds;
    this.filtervalues.PreviousApplied = this.filterForm.value.PreviousApplied;
    this.filtervalues.RelativeStatus = this.filterForm.value.RelativeStatus;
    this.filtervalues.SourceChannelId = this.filterForm.value.SourceChannelId;
    this.filtervalues.RequisitionDetailId = this.requisitionDetailId;
    this.filtervalues.CandidateOwner = this.filterForm.value.CandidateOwner;
  }
  reloadFilter(param) {
    this.filterForm.patchValue({
      ...
      ToDate: param.ToDate,
      HiringStatusId: param.HiringStatusId,
      GenderId: param.GenderId,
      FromAge: param.FromAge,
      ToAge: param.ToAge,
      AadharNo: param.AadharNo,
      ContactNo: param.ContactNo,
      EmailId: param.EmailId,
      MotherTongueIds: param.MotherTongueIds,
      LanguageIds: param.LanguageIds,
      QualificationId: param.QualificationId,
      CourseId: param.CourseId,
      StreamId: param.StreamId,
      FromPercent: param.FromPercent,
      ToPercent: param.ToPercent,
      CompletionYear: param.CompletionYear,
      QualificationTypeId: param.QualificationTypeId,
      FromExperience: param.FromExperience,
      ToExperience: param.ToExperience,
      FromCTC: param.FromCTC,
      ToCTC: param.ToCTC,
      CurrentEmployer: param.CurrentEmployer,
      Designation: param.Designation,
      DomainId: param.DomainId,
      SubDomainId: param.SubDomainId,
      StateIds: param.StateIds,
      PreviousApplied: param.PreviousApplied,
      RelativeStatus: param.RelativeStatus,
      SourceChannelId: param.SourceChannelId,
      //HiringStatusId: null,
      RequisitionDetailId: this.requisitionDetailId,
      CandidateOwner: param.CandidateOwner
    })
  }
  ...
  ngOnInit() {
    this.oldManagementApprovalId = 0;
  ...
  setFilterForm() {
    ...
    this.searchCandidate = {
      ...
      CompletionYears: this.filterForm.value.CompletionYear == 0 ? "" : this.filterForm.value.CompletionYear.join(","),
  ...
  select(evt, id, statusid, testOption, emailId, candidateNo, managementApprovalId) {
    ...
    if (this.candidateIds != "") {
      if (statusid == 1 && flag == 0) {
        ...
        this.btnViewManagementApprovalVisible = false;
      }
        ...
        if (this.oldManagementApprovalId == 0) {
          this.oldManagementApprovalId = managementApprovalId
          this.btnViewManagementApprovalVisible = true;
        }
        else if (this.oldManagementApprovalId == managementApprovalId) {
          this.btnViewManagementApprovalVisible = true;
        }
        else {
          this.btnViewManagementApprovalVisible = false;
  ...
  gotoCandidateAction(id: any, relativeStatus: any, childRelationshipId: any, cmdUpdateStatus: any) {
    if ((parseInt(childRelationshipId) > 1 || relativeStatus == "1") && cmdUpdateStatus == "0") {
      ...
      this.filtervalue();
      this.persistance.set('previouspagefilter', this.filtervalues);
  ...
  gotoTagCvDropCandidate() {
    ...
    this.persistance.set('pagename', "rmrequisitionlist");
    this.persistance.set('paramid', this.requisitionDetailId);
    this.persistance.set('data', this.data);
    this.filtervalue();
    this.persistance.set('previouspagefilter', this.filtervalues);
    this.persistance.set('tabledisplayStartcandi', this.pagValue);
  ...
  gotoRMRequisitionList() {
    ...
    } else {   // Added by anif on 29-04-2024 as after any action it was coming another page name so directly written else without checking others thing
      this.persistance.set('pagename', null)
      this.persistance.set('paramid', null)
      this.persistance.set('previouspageparams', this.persistance.get('previouspagefilters'));
      this.persistance.set('tabledisplayStart', this.persistance.get('tabledisplayStart'));
  ...
  loadDateTimePickerBack() {
    setTimeout(() => {
      jQuery('.dateTimepik').datetimepicker(
        {
          format: 'DD-MM-YYYY HH:mm',
          minDate: new Date().setMinutes(new Date().getMinutes() - 1),
          defaultDate: new Date().setMinutes(new Date().getMinutes())
        }
      );
      jQuery('.timepik').datetimepicker(
        {
  ...
  onInterviewSchedule() {
    ...
    if (flag == 0) {
      ...
      this.interviewScheduleFormData.candidateNo = candidateNos.slice(0, -1);
  ...
  btnInterviewNext() {
    ...
    // debugger
    var newtoDateTime, newformDateTime; //this code added by Amartya, new Date(this.tInterviewDate.nativeElement.value) was returning Nan on 31-07-2023
    if (this.tInterviewDate.nativeElement.value.length > 0) {
      var todateTime = this.tInterviewDate.nativeElement.value.split(" ");
    ...
    if (this.fInterviewDate.nativeElement.value.length > 0) {
      var formdateTime = this.fInterviewDate.nativeElement.value.split(" ");
      var formDate = formdateTime[0].split("-");
      var formTime = formdateTime[1].split(":");
      newformDateTime = new Date(Number(formDate[2]), Number(formDate[1]) - 1, Number(formDate[0]), Number(formTime[0]), Number(formTime[1]), 0, 0);
    }
    // var formdate=Date.parse(this.tInterviewDate.nativeElement.value);
    if (newtoDateTime < newformDateTime) {
      this.notificationService.showError("To Date Can't be less than From Date !! Please provide actual date", "Error");
      flag = 1
    }
    if (flag == 0) {
  ...
  SendDocumentCollectionCandidate() {
    ...
    this.documentCollectionFormData.createdBy = this.createdBy;  // Added By anif on 30-01-2025
  ...
  gotoManagementApproval(candidateId) {
    ...
    this.candidates = this.candidates.filter(x => x.candidateId == candidateId);
    for (var i = 0; i < this.candidates.length; i++) {
  ...
  gotoViewGenerateManagementApproval() {
    this.candidateIdNames = [];
    this.OnboardingMailIds = [];
