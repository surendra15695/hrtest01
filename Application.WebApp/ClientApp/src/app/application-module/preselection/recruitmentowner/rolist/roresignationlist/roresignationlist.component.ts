...
@Component({
  selector: 'app-roresignationlist',
  templateUrl: './roresignationlist.component.html',
  styleUrls: ['./roresignationlist.component.css']
})
export class RoresignationlistComponent implements OnInit {
