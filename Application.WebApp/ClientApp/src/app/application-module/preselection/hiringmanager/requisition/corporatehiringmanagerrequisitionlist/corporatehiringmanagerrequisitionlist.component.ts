...
@Component({
  selector: 'app-corporatehiringmanagerrequisitionlist',
  templateUrl: './corporatehiringmanagerrequisitionlist.component.html',
  styleUrls: ['./corporatehiringmanagerrequisitionlist.component.css']
})
export class CorporatehiringmanagerrequisitionlistComponent implements OnInit {
  ...
  //       //allocatedAutoUserId:Number(this.loginUserId)
  //     });
  ...
  gotoCandidateList(id,hrStatus, functionId, data) {
    ...
    this.persistance.set('pagetype', "corporate");
