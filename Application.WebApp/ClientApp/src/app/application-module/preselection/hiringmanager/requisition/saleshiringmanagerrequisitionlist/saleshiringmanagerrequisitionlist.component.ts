...
@Component({
  selector: 'app-saleshiringmanagerrequisitionlist',
  templateUrl: './saleshiringmanagerrequisitionlist.component.html',
  styleUrls: ['./saleshiringmanagerrequisitionlist.component.css']
})
export class SaleshiringmanagerrequisitionlistComponent implements OnInit {
...
/*    this.verticals.splice(0, 0, { verticalId: 0, verticalName: "All", isActive: true });*/
  ...
  gotoCandidateList(id,hrStatus, functionId, data){
    ...
    this.persistance.set('pagename', "saleshiringmanagerrequisitionlist");
