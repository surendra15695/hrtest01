...
@Component({
  selector: 'app-hiringmanagercandidateaction',
  templateUrl: './hiringmanagercandidateaction.component.html',
  styleUrls: ['./hiringmanagercandidateaction.component.css']
})
export class HiringmanagercandidateactionComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.persistance.get('pagename') != null || this.persistance.get('nextpagename') != null) {
      if (this.persistance.get('pagename') == "hiringmanagerrequisitionlist" && this.persistance.get('nextpagename') == "hiringmanagercandidateaction") {
        this.candidateId = this.persistance.get('candidateid');
        this.requisitionDetailId=this.persistance.get('paramid');
        this.getCandidateList();
      }else {
        this._route.navigate(['/app/requesterrequisitionlist']);
      }
    }
    else {
      this._route.navigate(['/app/requesterrequisitionlist']);
  ...
  gotoCandidatelist(){
    this.persistance.set('pagename',"corporatehiringmanagerrequisitionlist");
