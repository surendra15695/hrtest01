...
@Component({
  selector: 'app-holdreleasetransfersales',
  templateUrl: './holdreleasetransfersales.component.html',
  styleUrls: ['./holdreleasetransfersales.component.css']
})
export class HoldreleasetransfersalesComponent implements OnInit {
