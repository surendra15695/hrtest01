...
@Component({
  selector: 'app-holdreleasetransfercorporate',
  templateUrl: './holdreleasetransfercorporate.component.html',
  styleUrls: ['./holdreleasetransfercorporate.component.css']
})
export class HoldreleasetransfercorporateComponent implements OnInit {
