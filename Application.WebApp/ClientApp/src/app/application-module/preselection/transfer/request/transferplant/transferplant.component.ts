...
@Component({
  selector: 'app-transferplant',
  templateUrl: './transferplant.component.html',
  styleUrls: ['./transferplant.component.css']
})
export class TransferplantComponent implements OnInit {
    ...
    if (flag == 0) {
        ...
        this.transferDetailData.push(
          {
            ...
            newFunctionId: this.selectedVacancy.functionId,
            newDepartmentId: this.selectedVacancy.departmentId,
            requisitionDetailId: this.selectedVacancy.requisitionDetailId,
            requisitionNo: this.selectedVacancy.requisitionNo,
            positionId: 0,
            gradeId: 0,
            jobTypeId: 0,
            jobDescriptionId: 0,
      ...
      // Till this
        ...
        this.transferDetailDataArray.push({
          ...
          newFunctionId: this.selectedVacancy.functionId,
          newFunctionName: this.selectedVacancy.functionName,
          newDepartmentId: this.selectedVacancy.departmentId,
          newDepartmentName: this.selectedVacancy.departmentName,
          requisitionNo: this.selectedVacancy.requisitionNo,
          positionId: 0,
          positionName: "",
          gradeId: 0,
