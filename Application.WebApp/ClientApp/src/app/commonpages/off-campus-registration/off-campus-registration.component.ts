...
@Component({
  ...
  templateUrl: './off-campus-registration.component.html',
  styleUrls: ['./off-campus-registration.component.css']
})
export class OffCampusRegistrationComponent implements OnInit {
  saveForm: FormGroup;
  ...
  disableDipyear :boolean=false;
  disableDipmarks :boolean=false;
  disableDipCourse:boolean=false;
  disableDipSpecial:boolean=false;
  disableDipInstitute:boolean=false;
  disableDipInsname:boolean=false;
  disableDipInsloc:boolean=false;
  disabletweCourse :boolean=false;
  experiences:any=[];
  Months:any=[]
  isExperienced :boolean=false;
  ExperienceMonth: string="";
  ExperienceYear: string=""
  isRelativeVisible:boolean=false;
