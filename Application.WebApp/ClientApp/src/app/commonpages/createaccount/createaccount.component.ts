...
export class CreateaccountComponent implements OnInit {
  ...
  // onSubmit() {
  //   if (this.form.valid) {
  //     this.passwordOnCreateAccount = this.form.value.password;
  //     if (this.form.value.password == this.form.value.repassword) {
  //       this.SpinnerService.show();
  //       this.candidateService.createAccount(this.form.value).subscribe((result) => {
  //         if (result) {
  ...
  //             let obj = {
  //               userId: result.refNo,
  //               password: this.passwordOnCreateAccount
  //             }
  //             this.authService.login(obj);
  //             this.persistance.set('NewRegistration', 1);
  ...
  //         console.log(error);
  //         this.SpinnerService.hide();
  //         this.notificationService.showError("Something went wrong. Please later later !!", "Error");
  //       }, () => {
  //       });
  //     }
  //     else {
