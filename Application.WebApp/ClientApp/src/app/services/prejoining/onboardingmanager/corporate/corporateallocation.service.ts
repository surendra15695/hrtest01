...
export class CorporateallocationService {
  ...
  getCorporateAllocationCandidateList(formData: any): Observable<any> {
  ...
  updateBatchJoiningDate(formData: any): Observable<any> { 
    return this.httpClient.post<any>(this.apiURL + '/prejoiningdetails/batchjoiningdateupdate', formData, this.httpOptions)
      .pipe(
        catchError(this.errorHandler)
      )
  }
