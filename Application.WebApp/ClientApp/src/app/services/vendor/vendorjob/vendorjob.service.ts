...
export class VendorjobService {
  ...
  getVendorArchivedJobList(formData: any): Observable<any> {
    return this.httpClient.post<any>(this.apiURL + '/vendorjob/getarchivedjoblist', JSON.stringify(formData), this.httpOptions)
      .pipe(
        catchError(this.errorHandler)
      )
  }
