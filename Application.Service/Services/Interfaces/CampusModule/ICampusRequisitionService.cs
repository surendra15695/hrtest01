...
{
    public interface ICampusRequisitionService
    {
        ...
        Task<List<CampusLinkList>> GetAllCampusLink(SaerchCampusLink search);
        ...
        Task<List<CampusRequisitionTitleList>> GetAllCampusRequisitionTitleList(SearchCampusRequisitionTitle search);
