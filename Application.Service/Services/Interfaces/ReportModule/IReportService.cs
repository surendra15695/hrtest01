...
namespace Application.Service.Services.Interfaces.ReportModule
{
    public interface IReportService
    {
        ...
        Task<List<FlexiListGetAllCandiate>> GetAllCandidateFlexiReport(SearchFlexCandidateiList search);
        Task<List<FlexiListGetAllReq>> GetAllReqFlexiReport(SearchFlexiRequisitionList search);
        //Ankita
