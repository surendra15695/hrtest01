...
{
    public interface ICandidateReimbursemnetRepoitory
    {
        ...
        Task<ReturnMessage> SaveMedicalReimbursemtCandidate(EmployeeReimbursementData formdata);
        ...
        Task<ReturnMessage> SaveTravelReimbursementCandidate(EmployeeTravelReimbursementData1 formdata);//Argg
        ...
        Task<List<CandidateReimbursementBillSubmitList>> GetCandidateReimbursementBillSubmitListForDownload(CandidateReimbursementBillSubmitListSearchForZip search);
        Task<List<EmployeeReimbursementMedicalList>> GetCandidateMedicalReimbursementDwnloadAll(CandidateReimbursementBillSubmitListSearchForZip search);
        Task<List<EmployeeTravelReimbursementForZip>> GetTravelReimbursementCandidateForAll(CandidateReimbursementBillSubmitListSearchForZip search);
        Task<EmployeeMedicalReimbursementMedical2> GetMedicalReimbursemtCandidate2(EmployeeReimbursementSearch search);
